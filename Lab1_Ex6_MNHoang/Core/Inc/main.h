...
/* Private defines -----------------------------------------------------------*/
#define _12_Pin GPIO_PIN_4
#define _12_GPIO_Port GPIOA
#define _1_Pin GPIO_PIN_5
#define _1_GPIO_Port GPIOA
#define _2_Pin GPIO_PIN_6
#define _2_GPIO_Port GPIOA
#define _3_Pin GPIO_PIN_7
#define _3_GPIO_Port GPIOA
#define _4_Pin GPIO_PIN_8
#define _4_GPIO_Port GPIOA
#define _5_Pin GPIO_PIN_9
#define _5_GPIO_Port GPIOA
#define _6_Pin GPIO_PIN_10
#define _6_GPIO_Port GPIOA
#define _7_Pin GPIO_PIN_11
#define _7_GPIO_Port GPIOA
#define _8_Pin GPIO_PIN_12
#define _8_GPIO_Port GPIOA
#define _9_Pin GPIO_PIN_13
#define _9_GPIO_Port GPIOA
#define _10_Pin GPIO_PIN_14
#define _10_GPIO_Port GPIOA
#define _11_Pin GPIO_PIN_15

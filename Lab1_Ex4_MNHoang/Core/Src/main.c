...
int main(void)
{
  ...
  int YellowCounter = 2;
  int YellowCounter2 = 0;

  int OneSec_Counter = 1;
  ...
  while (1)
  {
    ...
    //alternate YELLOW ON
    HAL_GPIO_WritePin(GPIOA, GREEN_Pin, GPIO_PIN_RESET); // Green off
    HAL_GPIO_WritePin(GPIOA, GREEN_R_Pin, GPIO_PIN_RESET); // Green2 of
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, RED_Pin|YELLOW_Pin|GREEN_Pin|RED_R_Pin
                          |YELLOW_R_Pin|GREEN_R_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = RED_Pin|YELLOW_Pin|GREEN_Pin|RED_R_Pin
                          |YELLOW_R_Pin|GREEN_R_Pin;
